...
//  listRH.Add (staticRh, 5);
  ...
  /* output the xml file to be used by NetAnim pro*/
	AnimationInterface anim("anim.xml");
	anim.SetConstantPosition(src,0.0,2.0);
	anim.SetConstantPosition(a,0.0,1.5);
	anim.SetConstantPosition(b,1.0,1.5);
	anim.SetConstantPosition(c,1.0,1.0);
	anim.SetConstantPosition(d,1.0,0.5);
	anim.SetConstantPosition(dst,1.0,0);
